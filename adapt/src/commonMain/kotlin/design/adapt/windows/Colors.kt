...
data class WindowsColorScheme(
    ...
    val fillControlStrongDefault: Color,
    val fillControlSolidDefault: Color,
...
fun lightColorSchemeWindows(
    ...
    fillControlStrongDefault: Color = Color.Black.copy(alpha = 0.4458f),
    fillControlSolidDefault: Color = Color.White,
    ...
    fillControlSolidDefault = fillControlSolidDefault,
...
fun darkColorSchemeWindows(
    ...
    fillControlStrongDefault: Color = Color.White.copy(alpha = 0.5442f),
    fillControlSolidDefault: Color = Color(0xFF454545),
